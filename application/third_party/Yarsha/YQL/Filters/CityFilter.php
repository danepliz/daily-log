...
class CityFilter extends YQLFilter
{
	...
	*/		
	...
	public function getFilterElement()
	{
		...
		$repo = \CI::$APP->doctrine->em->getRepository('location\models\City');
	...
	public function getFilterValue(){
		$city = (is_numeric($this->city)) ? \CI::$APP->doctrine->em->find('location\models\City', $this->city)->getName() : 'ANY';
