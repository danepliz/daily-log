...
use Yarsha\YQL\Formatters\AggregateField;

use Yarsha\YQL\Formatters\ColumnFilter;
...
class Parser
{
	...
	private static $_FILTERS = array(
			'date'		=>	'Yarsha\YQL\Filters\DateFilter',
			'agent'		=>	'Yarsha\YQL\Filters\AgentFilter',
			'country'	=>	'Yarsha\YQL\Filters\CountryFilter',
			'or'		=> 'Yarsha\YQL\Filters\OrFilter',
			'freetext'	=> 'Yarsha\YQL\Filters\FreetextFilter',
			'state'		=> 'Yarsha\YQL\Filters\StateFilter',
			'city'		=> 'Yarsha\YQL\Filters\CityFilter',
			'countryagent' => 'Yarsha\YQL\Filters\CountryAgentFilter',
			'amount' 	=> 'Yarsha\YQL\Filters\AmountFilter',
			'agentstatus' => 'Yarsha\YQL\Filters\AgentStatusFilter',
			'transactionstatus' => 'Yarsha\YQL\Filters\TransactionStatusFilter',
		);
	
	public function __construct($input){
		$this->_input = $input;
		$this->_lexer = new \Yarsha\YQL\Lexer($input);	
	}
