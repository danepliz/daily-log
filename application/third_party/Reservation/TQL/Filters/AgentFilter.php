...
class AgentFilter extends TQLFilter
{
	...
	public function getSql()
	{
		...
		if(!\Current_User::isSuperUser() and \Current_User::user()->getGroup()->id() != Group::SUPER_AGENT_ADMIN and \Current_User::user()->getLevel() != User::USERLEVEL_PA)
		{
...
// 		if(count($countries) >1){ $ret .= '<option value=""> Any Country </option>'; }
	...
	public function getFilterScript()
	{
		...
		if(\Current_User::isSuperUser() or \Current_User::user()->getGroup()->id() == Group::SUPER_AGENT_ADMIN or \Current_User::user()->getLevel() == User::USERLEVEL_PA)
		{
