<?php use Reservation\REST\Response\UnknownMethodErrorResponse;
...
abstract class REST_Controller extends MX_Controller
{
	...
	public function _remap($object_called, $arguments)
	{
		...
		{
			$description = strtoupper($this->request->method)." on ".$this->called_resource." is not a valid method.";
			$response = new UnknownMethodErrorResponse();
