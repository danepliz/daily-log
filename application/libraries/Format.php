...
// 		throw new ErrorException("Invalid XML.");
	}
	...
	private function _from_json($string)
	{
		...
		switch (json_last_error()) {
			...
			case JSON_ERROR_DEPTH:
				throw new ErrorException("The maximum JSON stack depth has been exceeded");
				break;
			case JSON_ERROR_STATE_MISMATCH:
			case JSON_ERROR_SYNTAX:
				throw new ErrorException("Invalid or malformed JSON");
				break;
			case JSON_ERROR_CTRL_CHAR:
				throw new ErrorException("Control character error, possibly incorrectly encoded");
				break;
			case JSON_ERROR_UTF8:
				throw new ErrorException("Malformed UTF-8 characters, possibly incorrectly encoded");
				break;
			default:
				throw new ErrorException("Unknown error occurred.");
				break;
		}
