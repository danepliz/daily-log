...
class TransportRepository extends EntityRepository{
    ...
    public function listTransports( $offset = NULL, $per_page = NULL, $filters = array() ){
        $qb = $this->_em->createQueryBuilder();

        $qb->select('transport')
            ->from('transport\models\Transport', 'transport')
...
//            $qb->andWhere("hotel.name LIKE '%". $filters['name']."%'");
//
