...
/**
 * @ORM\Entity
 * @ORM\Table(name="ys_task_comment_attachment")
 */
class TaskCommentAttachment{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="task\models\TaskComment", inversedBy="attachments")
     */
    private $comment;
    ...
    public function setComment($taskComment)
    {
