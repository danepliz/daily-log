 ...
 * @ORM\Table(name="ys_hotels")
 */
class Hotel{

    const HOTEL_STATUS_ACTIVE = 'ACTIVE';
    const HOTEL_STATUS_SUSPENDED = 'SUSPENDED';
    const HOTEL_STATUS_CLOSED = 'CLOSED';
     ...
     * @ORM\JoinTable(name="ys_hotel_payable_currency_relations")
     */
    ...
    public static $hotel_status = array(
        self::HOTEL_STATUS_ACTIVE       => 'ACTIVE',
        self::HOTEL_STATUS_SUSPENDED    => 'SUSPENDED',
        self::HOTEL_STATUS_CLOSED       => 'CLOSED',
    );
    ...
    public function isActive(){
        return $this->status == self::HOTEL_STATUS_ACTIVE;
    }
    ...
    public function activate(){
        $this->status = self::HOTEL_STATUS_ACTIVE;
    }
