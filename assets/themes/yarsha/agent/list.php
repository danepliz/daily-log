...
$permitted_users="";
//$agentId = $p->getAgent() ? $agent->getAgent()->id() : NULL;
?>
                    ...
                    <table class="table table-striped">
                        ...
                        foreach($agents as $p):
                            ...
                            <tr <?php echo $class ?>>
                                ...
                                <td>   <?php
                                        if( $p['website1'] != '' ){
                                            $website1 = formatWebsite($p['website1']);
                                            echo anchor($website1, $p['website1'], 'target="_blank"');
                                        }
                                        if( $p['website2'] != '' ){
                                            echo '<br />';
                                            $website2 = formatWebsite($p['website2']);
                                            echo anchor($website2, $p['website2'], 'target="_blank"');
                                        }
                                    ?>
                                </td>
                                ...
                                <td class="actions"  style="padding: 5px;"><?php
