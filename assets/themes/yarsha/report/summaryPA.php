...
<div class="grid_12">
	...
	<form class="validate" action="" method="post" name="">
				...
				<td>
					...
					<?php 
						foreach ($agents as $ag) {
							$sel = ($_POST['agent'] == $ag['agent_id']) ? ' selected="selected"' : '';
	...
	<h3 titl="Daily Transaction Summary Report"><?php echo $agents[$a]['name']?> 
		<span> 
			<?php echo $total['count']?> <?php echo lang('Transaction_s');?> &nbsp;&mdash;&nbsp; <?php echo $agents[$a]['currency'] ?>
		</span>
	</h3>
	...
	<tbody>
		<tr>
			...
			<th rowspan="3" class=""><?php echo lang('Count');?></th>
