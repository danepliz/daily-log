...
$oldPhones = array();
?>
<form role="form" method="post" action="<?php echo site_url('hotel/add') ?>" class="validate" >
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group-sm">
                        ...
                        <?php getHotelStatusSelectElement('hotel_status', NULL, 'class="required form-control" id="hotel-status-select"') ?>
                    </div>
                </div>
            </div>
                ...
                <div class="panel-body">
                    <div class="form-group-sm">
                        ...
                        <input type="text" class="form-control number_only" name="fax"
                               value="<?php echo $this->input->post('fax')?>" />
                    </div>

                    <div class="form-group-sm">
                        <label for="website1">Website 1</label>
                        <input type="text" id="contact_website"  value="<?php echo $this->input->post('website1')?>" class="form-control website website_url" name="website1""/>
                    </div>

                    <div class="form-group-sm">
                        <label for="website2">Website 2</label>
                        <input type="text" id="contact_website" class="form-control website website_url"
                               value="<?php echo $this->input->post('website2')?>" name="website2"' />
                    </div>
                ...
                <div class="panel-body">
                    <div class="box-body">
                        ...
                        <div class="form-group-sm">
                            ...
                            <textarea name="address" id="address" class="required form-control"><?php echo set_value('address')?></textarea>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group-sm col-md-6 no-margin">
                        ...
                        <div class="input-group">
                            <input type="text" name="strategy_percent" value="<?php echo $this->input->post('strategy_percent') ?>" class="required form-control percent" />
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body ">
                    <div class="form-group-sm col-md-6 no-margin">
                        ...
                        ?>
                     <input type="checkbox" class="simple" name="room_basis" value="Room Basis" <?php echo $roomBasisChecked ?>><label>&nbsp;Room Basis</label></div>
<!--                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
<!--                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
                    <div class="form-group-sm col-md-6 no-margin">
                    <input type="checkbox"  class="simple" name="package_basis" value="Package Basis" <?php echo $packageBasisChecked ?>><label>&nbsp;Package Basis</label></div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group-sm">
                        ...
                        <textarea name="description" class="form-control" placeholder="other details" style="min-height: 13rem;" >
